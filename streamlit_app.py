...
st.write("จัดทำโดย นายธานัท โรจนวาสี 6604062610381")
...
st.markdown("""## ตัวข้อมูลที่จะเอามาใช้กับตัวโมเดลผมได้ให้ไว้ใน github แล้วครับชื่อ test ครับ มีรูปกับDataset ครับ""")
